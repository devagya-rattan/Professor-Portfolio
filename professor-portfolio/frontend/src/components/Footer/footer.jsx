    ...
    <footer className="bg-black text-white py-4   px-4 lg:px-40 min-h-[20vh] flex flex-col justify-between">
      <div className="lg:flex lg:justify-between">
        ...
        <div className="flex items-center pl-4 lg:pl-0 space-x-12 lg:space-x-10 mt-7 md:mt-7 mb-4 lg:mb-0">
          <a href="https://www.linkedin.com/in/dr-arun-kumar-verma-b1b12924/" target="_blank" rel="noopener noreferrer">
            <FaLinkedinIn className="h-5 w-5 md:h-7 md:w-6 text-white hover:opacity-40" />
          </a>
          <a href="mailto:arun.verma@iitjammu.ac.in" target="_blank" rel="noopener noreferrer">
            <BiLogoGmail className="h-5 w-5 md:h-7 md:w-6 hover:opacity-40" />
          </a>
          <a href="https://www.facebook.com/arun.k.verma.12/" target="_blank" rel="noopener noreferrer">
            <RiFacebookFill className="h-5 w-5 md:h-7 md:w-6 text-white hover:opacity-40" />
          </a>
          <a href="https://x.com/arunvermaiitd?lang=en" target="_blank" rel="noopener noreferrer">
            <FaTwitter className="h-5 w-5 md:h-7 md:w-6 text-white hover:opacity-40" />
          </a>
          <a href="https://scholar.google.com/citations?user=JSz7nTIAAAAJ&hl=th" target="_blank" rel="noopener noreferrer">
            <FaGoogleScholar className="h-5 w-5 md:h-7 md:w-6 text-white hover:opacity-40" />
          </a>
        </div>
      ...
      <div className="lg:flex  ">
        ...
        <div className="lg:flex lg:w-2/4 pl-4 lg:pl-0  lg:justify-between ">
          <div className='lg:hidden  block w-full  h-px bg-gray-600 mb-2'></div>
          <div className='hidden  lg:block w-px  h-full bg-gray-600'></div>
          <div className="lg:mb-2 mb-2 lg:pt-4 lg:px-14 lg:w-full lg:mx-4">
            <div>
              <p className="text-start  text-base  mb-1  texting ">
